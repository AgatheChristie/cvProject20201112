...
-export([
    add_server_boss_player/1
    , get_server_boss_player_by_id/1
    , update_server_boss_player/1
    , delete_server_boss_player/1
    , clear_all_server_boss_player/0
    , get_all_server_boss_player/0
    , get_all_in_server_boss_player/0
]).
