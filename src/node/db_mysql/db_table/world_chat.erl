...
fields() -> 
    ["id", "chat_type", "role_id", "chat_parts", "chat_sec", "is_light"].
...
to_row(Val) -> 
    to_row(Val, false).
to_row({world_chat, ID, CHAT_TYPE, ROLE_ID, CHAT_PARTS, CHAT_SEC, IS_LIGHT}, _Loop) -> 
    [ID, CHAT_TYPE, ROLE_ID, to_binary(chat_part:to_row(CHAT_PARTS, true)), CHAT_SEC, IS_LIGHT];
to_row('_', _Loop) -> 
    ['_', '_', '_', '_', '_', '_'];
to_row(none, false) -> 
    [0, 0, 0, <<>>, 0, 0];
...
to_rec([0, 0, 0, <<>>, 0, 0]) -> 
	 {world_chat, 0, 0, 0, <<>>, 0, 0};
to_rec([ID, CHAT_TYPE, ROLE_ID, CHAT_PARTS, CHAT_SEC, IS_LIGHT]) -> 
    {world_chat, ID, CHAT_TYPE, ROLE_ID, chat_part:to_rec_list(to_term(CHAT_PARTS)), CHAT_SEC, IS_LIGHT}.
...
to_rec_t([0, 0, 0, <<>>, 0, 0]) -> 
	   {world_chat, 0, 0, 0, <<>>, 0, 0};
to_rec_t([ID, CHAT_TYPE, ROLE_ID, CHAT_PARTS, CHAT_SEC, IS_LIGHT]) -> 
    {world_chat, ID, CHAT_TYPE, ROLE_ID, chat_part:to_rec_list_t(to_term(CHAT_PARTS)), CHAT_SEC, IS_LIGHT}.
