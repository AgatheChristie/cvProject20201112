...
%% 获取 .config里的配置信息
-export([get_log_level/1
    , get_tcp_listener/1
    , get_tcp_listener_ip/1
    , get_mysql_config/1
    , get_log_mongo_config/1
    , get_slave_mongo_config/1
    , has_slave_mongo_config/0
    , get_gateway_node/1
    , get_gateway_async_time/0, get_guest_account_url/1, get_can_gmcmd/1, get_strict_md5/1, get_http_ips/1, get_server_number/1, get_max_id/1, get_platform_name/0, get_card_key/0, get_server_num/0, get_server_name/0, get_opening_time/0, get_war_server_mark/0, get_war_server_info/0, get_war_client_info/0, get_auto_branching/0]).
